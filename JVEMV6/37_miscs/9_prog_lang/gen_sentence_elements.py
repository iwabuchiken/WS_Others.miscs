...
#_20190409_105133:caller
    ...
    '''###################
        step : 0.1
            prep : vars
    ###################'''
    numOf_Nouns_Chosen = 3
    numOf_Verbs_Chosen = 3
    numOf_Expressions_Chosen = 3
...
#     lo_Verbs = [x.strip() for x in lo_Verbs]
    ...
    for i in range(0, numOf_Verbs_Chosen):
        ...
        # choose
        noun_Chosen = lo_Verbs[random.randint(0, lenOf_LO_Verbs)]
    ...
    for i in range(0, numOf_Expressions_Chosen):
        ...
        # choose
        noun_Chosen = lo_Expressions[random.randint(0, lenOf_LO_Expressions)]
